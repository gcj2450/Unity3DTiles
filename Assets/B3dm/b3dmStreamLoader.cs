...
public class b3dmStreamLoader : MonoBehaviour
{
    ...
    private void Awake()
    {
        //可用地址https://storage.googleapis.com/vic-datasets-public/1ce41fe7-aed2-4ad3-be4d-c38b715ce9af/v1/tileset.json
        //https://storage.googleapis.com/ogc-3d-tiles/berlinTileset/tileset.json
        //get and parse tile.json 
        //string url = @"https://saturnus.geodan.nl/tomt/data/buildingtiles_adam/tileset.json";
        //string url = "file://D:/GitHub/Unity3DTiles/Assets/StreamingAssets/1_5cm_3dtiles/tileset.json";
        //string url = "file://D:/GitHub/Unity3DTiles/Assets/StreamingAssets/SampleTileset/tileset.json";
        //string url = "file://D:/GitHub/Unity3DTiles/Assets/StreamingAssets/Villeurbanne_Unity_2018/GratteCiel_bati_avec_texture/tileset.json";
        if (isAssetPath)
        {
